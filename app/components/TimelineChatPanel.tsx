...
export function TimelineChatPanel({ topic, startDate, endDate, timeline }: Props) {
    ...
    try {
      ...
      while (true) {
        ...
        for (const line of lines) {
          ...
          if (stripped === "[DONE]" || !stripped) continue;
      ...
      <div className="h-96 overflow-y-auto p-4 space-y-3">
        {messages.length === 0 && (
          <p className="text-xs text-slate-600 text-center mt-8">
            Ask about inflection points, dimensional shifts, or what the arc reveals.
          </p>
        )}
